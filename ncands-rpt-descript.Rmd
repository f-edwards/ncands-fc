...
mp1<-prof.rpt~scale(ch.pov.rt)+scale(inc.crime)+scale(ideo)+scale(pctblk)+
             scale(I(c.blk.pop/c.pop))+scale(I(c.amind.pop/c.pop))+scale(I(c.hisp.pop/c.pop))+
             scale(s.t.ratio)+scale(I(free.red.lunch/tot.students))+scale(I(libr/tot.students))+
             scale(I(health.emp+hosp.emp)/c.pop)+scale(I(police.emp/c.pop))+scale(I(welf.emp/c.pop))+
              (1|staterr)+(1|obs_n)

### src5=education personnel
me0<-src5~scale(ch.pov.rt)+scale(inc.crime)+scale(ideo)+scale(pctblk)+
             scale(I(c.blk.pop/c.pop))+scale(I(c.amind.pop/c.pop))+scale(I(c.hisp.pop/c.pop))+
             scale(s.t.ratio)+
              (1|staterr)+(1|obs_n)
...
e1<-s.t.ratio~scale(ch.pov.rt)+scale(inc.crime)+scale(ideo)+scale(pctblk)+
             scale(I(c.blk.pop/c.pop))+scale(I(c.amind.pop/c.pop))+scale(I(c.hisp.pop/c.pop))+
            (1|staterr)


mi1<-inf.rpt~scale(ch.pov.rt)+scale(inc.crime)+scale(ideo)+scale(pctblk)+
             scale(I(c.blk.pop/c.pop))+scale(I(c.amind.pop/c.pop))+scale(I(c.hisp.pop/c.pop))+
              (1|staterr)+(1|obs_n)

mp2<-prof.rpt~scale(ch.pov.rt)+scale(inc.crime)+scale(ideo)+
            scale(c.wht.pop/c.pop)+
              (1|staterr)+(1|obs_n)

mv1<-victims~scale(ch.pov.rt)+scale(inc.crime)+scale(ideo)+scale(pctblk)+
             scale(I(c.blk.pop/c.pop))+scale(I(c.amind.pop/c.pop))+scale(I(c.hisp.pop/c.pop))+
              (1|staterr)+(1|obs_n)

e1<-lmer(e1, data=cnty.dat)

e.0<-glmer(me0, data=cnty.dat, family=poisson, offset=log(child.pop))
...
sub.1<-lmer(scale(I(victims.x/tot.rpt.x))~scale(ch.pov.rt)+scale(inc.crime)+scale(ideo)+
             scale(I(c.blk.pop/c.pop))+scale(I(c.amind.pop/c.pop))+scale(I(c.hisp.pop/c.pop))+
